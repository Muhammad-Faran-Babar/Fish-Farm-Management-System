...
const App = () => {
  ...
  return (
    <>
      ...
      <Text style={styles.text5}> Enter Electricity Bill Record </Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.title2}>
          ...
          <TextInput
            ...
            value={datamodel.BillMonth}
            onChangeText={text => setDataModel({...datamodel, BillMonth: text})}
        ...
        <View style={styles.title2}>
          ...
          <TextInput
            ...
            onChangeText={text =>
              setDataModel({...datamodel, MeterNumber: text})
            }
            style={styles.textinput}></TextInput>
        </View>

        <View style={styles.title2}>
          <Text style={styles.text}>Numnber of Units Consumed:</Text>

          <TextInput
            placeholder="Units Consumed"
            value={datamodel.UnitConsumed}
            onChangeText={text =>
              setDataModel({...datamodel, UnitConsumed: text})
            }
            style={styles.textinput}></TextInput>
        </View>
        <View style={styles.title2}>
          <Text style={styles.text}> Enter This Month Bill Amount:</Text>

          <TextInput
            placeholder="Bill Amount"
            value={datamodel.BillAmount}
            onChangeText={text =>
              setDataModel({...datamodel, BillAmount: text})
            }
            style={styles.textinput}></TextInput>
        </View>
        <View style={styles.title2}>
          <Text style={styles.text}>Enter Amount Of Previous Month Bill </Text>

          <TextInput
            placeholder="Previous Bill Amount"
            value={datamodel.PreviousMonthBill}
            onChangeText={text =>
              setDataModel({...datamodel, PreviousMonthBill: text})
            }
            style={styles.textinput}></TextInput>
        </View>
        <View style={styles.title2}>
