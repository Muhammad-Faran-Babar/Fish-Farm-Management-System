...
const App = props => {
  ...
  return (
    <>
      ...
      <Text style={styles.TitleView}>Fish Medicine Stock Reports</Text>
      {/* {
        (state.options = 'Medstock' && ( */}
      <FlatList
          ...
          return (
            <>
              <View style={styles.flatlistview}>
                ...
                <Text style={styles.TextView}>
                  Name Of Medicine: {item.NameOfMed}
                </Text>
                <Text style={styles.TextView}>
                  Quantity Of Medicine: {item.QuantityOfMed}
                </Text>
                ...
                <Text style={styles.TextView}>
                  Availabe Units Before Buying: {item.AvailabeUnits}
                </Text>
