...
const App = props => {
  ...
  return (
    <>
      ...
      <Text style={styles.TitleView}>Feed Stock Reports</Text>
          ...
          return (
            <>
              <View style={styles.flatlistview}>
                ...
                <Text style={styles.TextView}>Type Of Feed: {item.picker}</Text>
                <Text style={styles.TextView}>
                  Wieght Of A Bag Of Feed: {item.quantity}
                </Text>
                <Text style={styles.TextView}>
                  Price Per Bag: {item.amount}
                </Text>
                <Text style={styles.TextView}>
                  Total Bags: {item.TotalNumberOfBags}
                </Text>
                <Text style={styles.TextView}>Total Price: {item.price}</Text>
                <Text style={styles.TextView}>
                  Number Of Bags Needed: {item.BeforeNeededUnits}
                </Text>
                <Text style={styles.TextView}>
                  Total Quantity After Addition: {item.afterNeededUnits}
                </Text>
