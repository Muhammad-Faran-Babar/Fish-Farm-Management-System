      ...
      <>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.title2}>
            <Text style={styles.text5}> Enter Fertilizer Stock Record </Text>
            ...
            <Text style={styles.text}>Enter The Type Of Fertilizer: </Text>
            <TextInput
              placeholder="Fertilizer Name"
              value={datamodel.FertilizerName}
              onChangeText={text =>
                setDataModel({...datamodel, FertilizerName: text})
              }
              style={styles.textinput}></TextInput>
            {/* <Picker
            ...
            <Text style={styles.text}>
              Enter Total Bags Of Fertilizer Bought:
            </Text>
            ...
            <TextInput
              ...
              style={styles.textinput}></TextInput>
            <Text style={styles.text}>Wieght Per Bag:</Text>
            <TextInput
              placeholder="Wieght per Bag"
              value={datamodel.WieghtPerBag}
              onChangeText={text =>
                setDataModel({...datamodel, WieghtPerBag: text})
              }
              style={styles.textinput}></TextInput>

            <Text style={styles.text}>Price Of Per Bag:</Text>
            <TextInput
              placeholder="Total Units"
              value={datamodel.PriceOfBag}
              onChangeText={text =>
                setDataModel({...datamodel, PriceOfBag: text})
              }
              style={styles.textinput}></TextInput>

            <Text style={styles.text}>Enter Purchasing Price:</Text>
            ...
            <Text style={styles.text}>Enter Number Of Units Needed:</Text>
            <Text
              style={{
                fontStyle: 'italic',
                fontSize: 11,
            ...
            <TextInput
              placeholder=" Needed Quantity Of Fertilizer"
            ...
            <Text style={styles.text}>Enter Total Number Of Units:</Text>
            <Text
              style={{
                fontStyle: 'italic',
                fontSize: 11,
