...
const App = props => {
  ...
  return (
    <>
      ...
      <Text style={styles.TitleView}>Fertilizer Stock Reports</Text>
          ...
          return (
            <>
              <View style={styles.flatlistview}>
                ...
                <Text style={styles.TextView}>
                  Fertilizer Name: {item.FertilizerName}
                </Text>
                <Text style={styles.TextView}>
                  Quantity Of Bags: {item.quantity}
                </Text>
                <Text style={styles.TextView}>
                  Wieght Per Bag: {item.WieghtPerBag}
                </Text>
                <Text style={styles.TextView}>
                  Price Of Bag: {item.PriceOfBag}
                </Text>
                <Text style={styles.TextView}>Total Price: {item.price}</Text>
                <Text style={styles.TextView}>
                  Required Fertilizer Units Before Buying:{' '}
                  {item.BeforeNeededUnits}
                </Text>
                <Text style={styles.TextView}>
                  Total Fertilizer Units After Buying: {item.afterNeededUnits}
                </Text>
