      ...
      <>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.title2}>
            <Text style={styles.text5}> Enter Medicine Stock Record </Text>
            ...
            <Text style={styles.text}>Enter Name of Medicine Bought</Text>

            <TextInput
              value={datamodel.NameOfMed}
              onChangeText={text =>
                setDataModel({...datamodel, NameOfMed: text})
              }
              placeholder="Name Of Medicine"
              style={styles.textinput}></TextInput>

            <Text style={styles.text}>Enter Quantity in Number:</Text>

            <TextInput
              value={datamodel.QuantityOfMed}
              onChangeText={text =>
                setDataModel({...datamodel, QuantityOfMed: text})
              }
            ...
            <Text style={styles.text}>Units Of Medicine Available:</Text>
            <Text
              style={{
                fontStyle: 'italic',
                fontSize: 11,
            ...
            <TextInput
              value={datamodel.AvailabeUnits}
              onChangeText={text =>
                setDataModel({...datamodel, AvailabeUnits: text})
              }
              placeholder="Availabe Units"
              style={styles.textinput}></TextInput>
