...
const App = props => {
  ...
  return (
    <>
      ...
      <Text style={styles.TitleView}>Pond Condition Reports</Text>
          ...
          return (
            <>
              <View style={styles.flatlistview}>
                ...
                <Text style={styles.TextView}>
                  Temprature Of Pond: {item.TempratureOfPond}
                </Text>
                <Text style={styles.TextView}>ph Of Pond: {item.phOfPond}</Text>
                <Text style={styles.TextView}>
                  Number Of Fish: {item.NumberOfFish}
                </Text>
                <Text style={styles.TextView}>
                  Number Of Fish: {item.TypesOfFish}
                </Text>
