...
const App = props => {
  ...
  return (
    <>
      ...
      <Text style={styles.TitleView}>Employee Reports</Text>
      {
        (state.options = 'feedstock' && (
          <FlatList
            data={stockData}
              ...
              return (
                <>
                  <View style={styles.flatlistview}>
                    ...
                    <Text style={styles.TextView}>
                      CNIC Of Employee: {item.Cnic}
                    </Text>
                    <Text style={styles.TextView}>
                      Month Of Hiring: {item.MonthOfHiring}
                    </Text>
                    <Text style={styles.TextView}>
                      Purpose Of Hiring: {item.Purpose}
                    </Text>
                    <Text style={styles.TextView}>
