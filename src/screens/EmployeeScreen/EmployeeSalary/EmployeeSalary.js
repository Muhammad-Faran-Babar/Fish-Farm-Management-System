    ...
    <>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.title2}>
          <Text style={styles.text5}> Enter Salary Expense Record </Text>
        ...
        <View style={styles.title2}>
          <Text style={styles.text}>Employee Mobile Number:</Text>
        ...
        <View style={styles.title2}>
          <Text style={styles.text}>Enter The Amount Of Bonus:</Text>
          <Text
            style={{
              fontStyle: 'italic',
              fontSize: 11,
          ...
          <TextInput
            placeholder="Bonus"
            value={datamodel.Bonus}
            onChangeText={text => setDataModel({...datamodel, Bonus: text})}
            style={styles.textinput}></TextInput>
        </View>
        <View style={styles.title2}>
          <Text style={styles.text}>Enter The Deduction Amount:</Text>
          <Text
            style={{
              fontStyle: 'italic',
              fontSize: 11,
          ...
          <TextInput
            ...
            value={datamodel.Deduction}
            onChangeText={text => setDataModel({...datamodel, Deduction: text})}
            style={styles.textinput}></TextInput>
          <View style={styles.title2}>
            <Text style={styles.text}> Enter The Total Amount:</Text>

            <TextInput
              placeholder="Total Salary"
              value={datamodel.TotalSalary}
              onChangeText={text =>
                setDataModel({...datamodel, TotalSalary: text})
              }
              style={styles.textinput}></TextInput>
          </View>
          <View style={styles.title2}>
