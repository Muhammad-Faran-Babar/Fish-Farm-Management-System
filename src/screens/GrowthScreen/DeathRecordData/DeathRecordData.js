...
const App = props => {
  ...
  return (
    <>
      ...
      <Text style={styles.TitleView}>Fish Death Reports</Text>
          ...
          return (
            <>
              <View style={styles.flatlistview}>
                ...
                <Text style={styles.TextView}>
                  Species Of Fish That Died: {item.FishType}
                </Text>

                <Text style={styles.TextView}>
                  Number Of Fish Before Death: {item.FishBeforeDeath}
                </Text>
                <Text style={styles.TextView}>
                  Number Of Died Fish: {item.DiedFish}
                </Text>
                <Text style={styles.TextView}>
                  Number Of Fish After Death: {item.FishAfterDeath}
                </Text>
