  ...
  return (
    <>
      <View style={styles.header}>
        ...
        <Text style={styles.title}> Selling Details </Text>
        <View style={styles.button}>
          <TouchableOpacity
            style={styles.smallButton}
            onPress={() => {
              props.navigation.navigate('FishSellScreen');
      ...
      <Text style={styles.TitleView}>Fish Selling Reports</Text>
          ...
          return (
            <>
              <View style={styles.flatlistview}>
                ...
                <Text style={styles.TextView}>Buyer Name: {item.UserName}</Text>
                <Text style={styles.TextView}>Buyer CNIC: {item.UserCNIC}</Text>
                ...
                <Text style={styles.TextView}>
                  Fish Species: {item.FishType}
                </Text>
                <Text style={styles.TextView}>
                  Sold Number Of Pieces: {item.PiecesNumber}
                </Text>
                <Text style={styles.TextView}>
                  Category Of Wieght: {item.picker}
                </Text>
                <Text style={styles.TextView}>
                  Price According To Wieght: {item.PriceWieght}
                </Text>
                <Text style={styles.TextView}>
                  Total Wieght: {item.TotalWieght}
                </Text>
                <Text style={styles.TextView}>
